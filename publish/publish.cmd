...
set "APP_ID=294100"
set "CHANGENOTE=Quest recruitment system + Medieval scenario + load-order fix. Kurin Republic renamed to The Dawnforge Collective. New default for non-scenario starts: Aethira leads the Collective as an NPC and the player recruits her via a 3-step goodwill chain (Whispers 50, Trial 80, Calling 100 + Divine Shrine). Auto-spawn (legacy) and Disabled modes remain available in mod settings. New 'The Celestial Fox - Medieval' scenario: pre-firearm tier, pre-researched Smithing/Complex Furniture/Stonecutting, founds a keep. Auto-leader gate: she no longer seizes the leader role of unrelated player ideologies (only Demigodess Worship). Settings menu now scrolls so the bottom checkboxes are reachable on small screens. Terrain immunity now patches both 2-arg and 3-arg CostToMoveIntoCell overloads. Load order fix per the original Kurin HAR author: Nals.FacialAnimation moved from loadBefore to loadAfter, breaks the RimSort circular-dependency warning. Patch count is now 34."
